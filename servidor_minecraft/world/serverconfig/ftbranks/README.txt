...
Last README file update: Tue Dec 16 04:41:34 UTC 2025
...
command.fclib.args
command.fclib.info
command.fclib.info.type
command.fclib.info.type.outputTagInstead
command.fclib.info.type.outputTagInstead.tagIndex
command.fclib.reload
command.fill
command.fill.from
...
command.hexblades
command.hexblades.devotion
command.hexblades.devotion.player
command.hexblades.devotion.player.get
command.hexblades.devotion.player.get.deity
command.hexblades.devotion.player.set
command.hexblades.devotion.player.set.deity
command.hexblades.devotion.player.set.deity.qt
command.hexblades.facts
command.hexblades.facts.player
command.hexblades.facts.player.give
command.hexblades.facts.player.give.fact
command.hexblades.facts.player.has
command.hexblades.facts.player.has.fact
command.hexblades.knowledge
command.hexblades.knowledge.player
command.hexblades.knowledge.player.give
command.hexblades.knowledge.player.give.knowledge
command.home
command.home.name
command.ie
...
command.locate.ba_bt:land_battle_tower
...
command.locate.dungeons_enhanced:castle
command.locate.dungeons_enhanced:desert_temple
command.locate.dungeons_enhanced:desert_tomb
command.locate.dungeons_enhanced:druid_circle
command.locate.dungeons_enhanced:dungeon_variant
command.locate.dungeons_enhanced:elders_temple
command.locate.dungeons_enhanced:fishing_ship
command.locate.dungeons_enhanced:flying_dutchman
command.locate.dungeons_enhanced:hay_storage
command.locate.dungeons_enhanced:ice_pit
command.locate.dungeons_enhanced:jungle_monument
command.locate.dungeons_enhanced:large_dungeon
command.locate.dungeons_enhanced:miners_house
command.locate.dungeons_enhanced:monster_maze
command.locate.dungeons_enhanced:mushroom_house
command.locate.dungeons_enhanced:pillager_camp
command.locate.dungeons_enhanced:pirate_ship
command.locate.dungeons_enhanced:ruined_building
command.locate.dungeons_enhanced:stables
command.locate.dungeons_enhanced:sunken_shrine
command.locate.dungeons_enhanced:tall_witch_hut
command.locate.dungeons_enhanced:tower_of_the_undead
command.locate.dungeons_enhanced:tree_house
command.locate.dungeons_enhanced:watch_tower
command.locate.dungeons_enhanced:witch_tower
...
command.locate.hexblades:fire_temple
